...
**Features:** 45 network traffic features including packet rates, protocol statistics, and connection metrics extracted from TCP traffic captured using tcpdump.
